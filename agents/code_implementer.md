...
2.  **Algorithm & Approach Selection:**
    ...
    - Justify _why_ this approach is considered optimal (e.g., efficiency in terms of time/space complexity, scalability, simplicity, robustness for the given constraints).
...
- Work on ONLY the single task specified below
...
6. You can add or edit files to finish your task successfully.
7. Follow the design instructions.
8. After completing the implementation, update any relevant documentation (README files, API docs, inline comments, etc.) to reflect the changes made.
