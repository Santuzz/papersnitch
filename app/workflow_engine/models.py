...
class WorkflowRun(models.Model):
    ...
    total_tokens = models.IntegerField(
        default=0,
        help_text="Total tokens (input + output) used by this workflow run"
    )
...
class WorkflowNode(models.Model):
    ...
    input_tokens = models.IntegerField(
        default=0,
        help_text="Number of input tokens consumed by this node"
    )
    output_tokens = models.IntegerField(
        default=0,
        help_text="Number of output tokens generated by this node"
    )
    total_tokens = models.IntegerField(
        default=0,
        help_text="Total tokens (input + output) used by this node"
    )
