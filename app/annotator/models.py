...
class Document(models.Model):
    ...
    conversion_status = models.CharField(max_length=20, choices=STATUS_CHOICES, default='pending')
    conversion_error = models.TextField(blank=True, null=True, help_text="Error message if conversion failed")
...
class Annotation(models.Model):
    ...
    category = models.ForeignKey('AnnotationCategory', on_delete=models.PROTECT, related_name='annotations')
